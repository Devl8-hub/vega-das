...
set(PROJECT_DESCRIPTION  "Vega DAS is a powerful 3D data analysis suite.")
set(PROJECT_COPYRIGHT    "Copyright (C) 2024-${CURRENT_YEAR} Vega DAS Team")
set(PROJECT_CONTACT      "support@vegadas.com")
set(PROJECT_VENDOR       "Vega DAS Team")
...
set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_SOURCE_DIR}/VEGA_COPYING.txt")
...
if(DEFINED ENV{BUILD_REV})
  set(BUILD_REV $ENV{BUILD_REV})
else()
...
if(NOT CPACK_OVERRIDE_PACKAGENAME)
    set(CPACK_OVERRIDE_PACKAGENAME "Vega-DAS")
endif()
if(MSVC)
...
if(CPACK_OVERRIDE_PACKAGENAME)
  set(CPACK_PACKAGE_FILE_NAME ${CPACK_OVERRIDE_PACKAGENAME}-${MAJOR_VERSION}.${MINOR_VERSION}.${PATCH_VERSION}-${PACKAGE_ARCH})
else()
...
if(APPLE)
  ...
  set(CPACK_DMG_VOLUME_NAME "Vega DAS")
...
if(WIN32)
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "Vega DAS/Vega DAS ${MAJOR_VERSION}.${MINOR_VERSION}")
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "Vega DAS/Vega DAS ${MAJOR_VERSION}.${MINOR_VERSION}")
  ...
  set(CPACK_RESOURCE_FILE_LICENSE ${CMAKE_SOURCE_DIR}/VEGA_COPYING.txt)
  set(CPACK_WIX_PRODUCT_ICON ${CMAKE_SOURCE_DIR}/release/windows/icons/vegadas.ico)
...
set(CPACK_PACKAGE_EXECUTABLES "vega_das" "Vega DAS ${MAJOR_VERSION}.${MINOR_VERSION}")
set(CPACK_CREATE_DESKTOP_LINKS "vega_das" "Vega DAS ${MAJOR_VERSION}.${MINOR_VERSION}")
