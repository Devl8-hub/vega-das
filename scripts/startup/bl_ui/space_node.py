...
class NODE_HT_header(Header):
    ...
    def draw(self, context):
        ...
        layout.menu("MINIMAL_MT_editor_types", text="", icon='NODE_MATERIAL')
        ...
        # MINIMAL UI: Removed Node Editor snap controls
        # row = layout.row(align=True)
...
class NODE_MT_editor_menus(Menu):
    ...
    def draw(self, _context):
        ...
        snode = _context.space_data
        is_shader = snode.tree_type == "ShaderNodeTree"
