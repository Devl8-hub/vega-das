...
class PROPERTIES_MT_tabs_visibility(Menu):
    ...
    def draw(self, _context):
        ...
        for prop, name, icon in tabs_attr_infos:
            layout.prop(space, prop, text=iface_(name), icon=icon)





class PROPERTIES_MT_context_switch(Menu):
    bl_label = "Context"

    def draw(self, _context):
        layout = self.layout
        space = _context.space_data
        layout.prop_enum(space, "context", "OBJECT")
        layout.prop_enum(space, "context", "DATA")
        layout.prop_enum(space, "context", "MATERIAL")
        op = layout.operator("wm.context_set_enum", text="Render", icon='SCENE')
...
class PROPERTIES_HT_header(Header):
    ...
    def draw(self, context):
        ...
        layout.menu("MINIMAL_MT_editor_types", text="", icon='PROPERTIES')

        layout.separator_spacer()

        # Context selection dropdown (restricted)
        layout.menu("PROPERTIES_MT_context_switch", text="", icon='PROPERTIES')
...
classes = (
    ...
    PROPERTIES_MT_tabs_visibility,
    PROPERTIES_MT_context_switch,
