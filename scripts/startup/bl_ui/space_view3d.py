...
class VIEW3D_MT_interaction_mode_minimal(Menu):
    ...
    def draw(self, context):
        ...
        # Object Mode
        layout.operator("object.mode_set", text="Object Mode", icon='OBJECT_DATAMODE').mode = 'OBJECT'
        # Edit Mode
        layout.operator("object.mode_set", text="Edit Mode", icon='EDITMODE_HLT').mode = 'EDIT'
        # Vertex Paint (Retained as per plan)
...
class VIEW3D_HT_header(Header):
    ...
    def draw(self, context):
        ...
        # MINIMAL UI: Custom editor type menu instead of built-in template_header()
        layout.row(align=True).menu("MINIMAL_MT_editor_types", text="", icon='VIEW3D')
        ...
        sub = row.row(align=True)
        # Use custom minimal menu instead of full enum menu
        sub.menu("VIEW3D_MT_interaction_mode_minimal", text=iface_(act_mode_item.name, act_mode_i18n_context), icon=act_mode_item.icon)
        ...
        if object_mode in {'PAINT_GREASE_PENCIL', 'SCULPT_GREASE_PENCIL'}:
            ...
            # MINIMAL UI: Transform controls removed
...
class VIEW3D_MT_editor_menus(Menu):
    ...
    def draw(self, context):
        ...
        # MINIMAL UI: Add and Object menus removed
        # if mode_string == 'OBJECT':
        #     layout.menu("VIEW3D_MT_add")
        # ...

        # MINIMAL UI: Edit menus removed
        # if edit_object:
        #     layout.menu("VIEW3D_MT_edit_" + edit_object.type.lower())
        #     ...

        # MINIMAL UI: Mode-specific menus removed
        # elif obj:
        #     ...
        # else:
...
class VIEW3D_MT_view(Menu):
    ...
    def draw(self, context):
        ...
        # MINIMAL UI: Simplified View menu
...
class VIEW3D_MT_edit_mesh_context_menu(Menu):
    ...
    def draw(self, context):
        ...
        if is_vert_mode:
            ...
            # Removal Operators
            if selected_verts_len > 1:
                pass # col.menu("VIEW3D_MT_edit_mesh_merge", text="Merge Vertices")
        ...
        if is_edge_mode:
            ...
            if selected_edges_len >= 2:
                pass # col.operator("mesh.bridge_edge_loops")
            if selected_edges_len >= 1:
                pass # col.operator("mesh.edge_face_add", text="New Face from Edges")
            if selected_edges_len >= 2:
                pass # col.operator("mesh.fill")
        ...
        if is_face_mode:
            ...
            if selected_faces_len >= 2:
                pass # col.operator("mesh.bridge_edge_loops", text="Bridge Faces")
...
classes = (
    ...
    VIEW3D_MT_interaction_mode_minimal,
)
